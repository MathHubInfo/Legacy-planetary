...
/* I don't know if this should be placed here as a global variable but...it works*/
var root_fix = null;
console = console || {
   log   : function(){},
   warn  : function(){},
	 ...
	 if ( typeof opt.root != "undefined"){
		...
		root_fix = opt.root;
         ...
         com.menu
            ...
            .live('mouseenter.showSubmenu', function(e){
               ...
               $(com.self).trigger('beforeShowSubmenu', [e, $(this)]);
      ...
      getModuleDependencies : function( module ){
         ...
         for( var i in d ){
            if( this._com.modules.enabled[d[i]] )
               ...
               result.modules.notFound.push( d[i] );
         }
      ...
      resolveModuleDependencies : function( module ){
         ...
         if( d.scripts.missing.length ){
            for( i in d.scripts.missing ){
               this.loadScript( d.scripts.missing[i] );
            }
         }
      ...
      setView : function( identifier ){
         ...
         if( this._com.currentView )
            this._com.currentView._stylesheets.attr('disabled', true);

         // Load/enable new StyleSheets
         if( view.stylesheets && view.stylesheets.length ){
            if( view._stylesheets && view._stylesheets.length ){
               view._stylesheets.attr('disabled', false);
            } else {
               view._stylesheets = $();
               for( var j in view.stylesheets ){
                  var script = this.loadScript( this._com.root+view.stylesheets[j], view.info.identifier );
                  if( script )
               ...
               view._stylesheets.attr('disabled', true).attr('disabled', false);
            }
         }
      ...
      templates   : {
         ...
         view  : {
            ...
            _stylesheets : $(),
            /**
             * Initializes the view. Typically sets the menu attribute
             * @param {tContextMenu} menu
             */
            init : function( menu ){
               this.menu = menu;
            },
            ...
            render : function( itemList ){
               ...
               for( var i in itemList ){
                  ...
                  if( itemList[i].smallIcon ){
                     itemList[i].element.prepend('<img src="'+root_fix+itemList[i].smallIcon+'" class="'+this.menu._cls.smallIcon+'"/>');
                  }
         ...
         module   : {
            ...
            images   : {},
            /**
             * A method that is called once the module has been loaded
             */
            init     : (function(){
               return function(){};
            })(),
