...
*/
var JOBAD=function(){var a=function(b){if(!(this instanceof a))return new a(b);this.arguments=[];for(var d=0;d<arguments.length;d++)this.arguments.push(arguments[d]);this.element=b;a.refs._.isElement(this.element)&&(this.element=a.refs.$(this.element));this.element instanceof a.refs.$||a.error("Can't create JOBADInstance: Not a DOM Element. ");for(d=0;d<a.ifaces.length;d++){var c=a.ifaces[d];"function"==typeof c&&c.call(this,this,this.arguments)}};a.ifaces=[];a.version="3.0.0";a.toString=function(){return"function(/* JOBAD "+
...
a.noConflict.$=function(){a.refs.$=a.refs.$.noConflict();return a.refs.$};a.noConflict._=function(){a.refs._=a.refs._.noConflict();return a.refs._};Array.prototype.indexOf||(Array.prototype.indexOf=function(a){if(null==this)throw new TypeError;var d=Object(this),c=d.length>>>0;if(0===c)return-1;var e=0;1<arguments.length&&(e=Number(arguments[1]),e!=e?e=0:0!=e&&(Infinity!=e&&-Infinity!=e)&&(e=(0<e||-1)*Math.floor(Math.abs(e))));if(e>=c)return-1;for(e=0<=e?e:Math.max(c-Math.abs(e),0);e<c;e++)if(e in
d&&d[e]===a)return e;return-1});a.util={};a.util.bindEverything=function(b,d){if(a.refs._.isObject(b)&&"function"!=typeof b){var c={},e;for(e in b)c[e]=a.util.bindEverything(b[e],d);return c}return"function"==typeof b?a.refs._.bind(b,d):a.refs._.clone(b)};a.util.UID=function(){var a=(new Date).getTime(),d=Math.floor(1E3*Math.random()),c=Math.floor(1E3*Math.random());return""+a+"_"+d+"_"+c};a.ifaces.push(function(b){var d={},c=[];this.modules={};this.modules.load=function(c,f,g){if(!b.modules.loaded(c)){if("boolean"==
typeof g&&g)a.modules.available(c)||a.error("Error loading module "+c),d[c]=new a.modules.loadedModule(c,f,b),d[c].onActivate(b);else{g=a.modules.getDependencyList(c);if(!g)return a.console.warn("Unresolved dependencies for module '"+c+"'. "),!1;for(c=0;c<g.length;c++)b.modules.load(g[c],f,!0)}return!0}};this.modules.loaded=function(a){return d.hasOwnProperty(a)};this.modules.deactivate=function(e){b.modules.isActive(e)?(c.push(e),d[e].onDeactivate(b)):a.console.warn("Module '"+e+"' is already deactivated. ")};
this.modules.activate=function(e){b.modules.isActive(e)?a.console.warn("Module '"+e+"' is already activated. "):(c=a.refs._.without(c,e),d[e].onActivate(b))};this.modules.isActive=function(b){return-1==a.refs._.indexOf(c,b)};this.modules.getIdentifiers=function(){var a=[],b;for(b in d)d.hasOwnProperty(b)&&a.push(b);return a};this.modules.getLoadedModule=function(b){if(d.hasOwnProperty(b))return d[b];a.console.warn("Can't find JOBAD.modules.loadedModule instance of '"+b+"'")};this.modules.iterate=
function(a){var c=[],g;for(g in d)if(d.hasOwnProperty(g)&&b.modules.isActive(g)){var h=a(d[g]);if(h)c.push(h);else break}return c};this.modules.iterateAnd=function(a){for(var c in d)if(d.hasOwnProperty(c)&&b.modules.isActive(c)&&!a(d[c]))return!1;return!0}});a.modules={};a.modules.extensions={};a.modules.ifaces=[];a.modules.cleanProperties=["init","activate","deactivate","globalinit","info"];var p={},l={};a.modules.register=function(b){b=a.modules.createProperModuleObject(b);if(!b)return!1;var d=
b.info.identifier;if(a.modules.available(d))return!1;p[d]=b;l[d]={};return!0};a.modules.createProperModuleObject=function(b){if(!a.refs._.isObject(b))return!1;var d={globalinit:function(){},init:function(){},activate:function(){},deactivate:function(){}},c;for(c in d)if(d.hasOwnProperty(c)&&b.hasOwnProperty(c)){if("function"!=typeof b[c])return!1;d[c]=b[c]}if(b.hasOwnProperty("info")){var e=b.info;d.info={version:"",dependencies:[]};if(e.hasOwnProperty("version")){if("string"!=typeof e.version)return!1;
d.info.version=e.version}d.info.hasCleanNamespace=e.hasOwnProperty("hasCleanNamespace")?!1==e.hasCleanNamespace?!1:!0:!0;if(e.hasOwnProperty("dependencies")){var f=e.dependencies;if(!a.refs._.isArray(f))return!1;d.info.dependencies=f}try{a.refs._.map(["identifier","title","author","description"],function(a){if(e.hasOwnProperty(a)){var b=e[a];if("string"!=typeof b)throw"";d.info[a]=b}else throw"";})}catch(g){return!1}d.namespace={};for(c in b)b.hasOwnProperty(c)&&-1==a.modules.cleanProperties.indexOf(c)&&
(d.info.hasCleanNamespace?a.console.warn("Warning: Module '"+d.info.identifier+"' says its namespace is clean, but property '"+c+"' found. Check ModuleObject.info.hasCleanNamespace. "):d.namespace[c]=b[c]);for(var h=0;h<a.modules.ifaces.length;h++)f=a.modules.ifaces[h],d=f[0].call(this,d,b);for(c in a.modules.extensions){var f=a.modules.extensions[c],h=b.hasOwnProperty(c),j=b[c];f.required&&!h&&a.error("Error: Cannot load module '"+d.info.identifier+"'. Missing required core extension '"+c+"'. ");
h&&(f.validate(j)||a.error("Error: Cannot load module '"+d.info.identifier+"'. Core Extension '"+c+"' failed to validate. "));d[c]=f.init(h,j,b,d)}return d}return!1};a.modules.available=function(b,d){d="boolean"==typeof d?d:!1;var c=p.hasOwnProperty(b);if(d&&c){for(var c=p[b].info.dependencies,e=0;e<c.length;e++)if(!a.modules.available(c[e],!0))return!1;return!0}return c};a.modules.getDependencyList=function(b){if(!a.modules.available(b,!0))return!1;var d=[b];b=p[b].info.dependencies;for(var c=b.length-
1;0<=c;c--)d=a.refs._.union(d,a.modules.getDependencyList(b[c]));return d};a.modules.loadedModule=function(b,d,c){a.modules.available(b)||a.error("Module is not available and cant be loaded. ");this.globalStore={get:function(a){return l[b][a+"_"]},set:function(a,c){l[b][a+"_"]=c},"delete":function(a){delete l[b][a+"_"]},keys:function(){var a=[],c;for(c in l[b])l[b].hasOwnProperty(c)&&"_"==c[c.length-1]&&a.push(c.substr(0,c.length-1));return a}};var e={};this.localStore={get:function(a){return e[a]},
set:function(a,b){e[a]=b},"delete":function(){delete e[b]},keys:function(){var a=[],b;for(b in e)e.hasOwnProperty(b)&&a.push(b);return a}};var f=p[b];this.info=function(){return f.info};this.getJOBAD=function(){return c};if(!l[b].init){l[b].init=!0;f.globalinit.apply(void 0,[]);for(var g in a.modules.extensions){var h=a.modules.extensions[g],j=f[g];if("function"==typeof h.onFirstLoad)h.onFirstLoad(this.globalStore)}}for(var k=[c],j=0;j<d.length;j++)k.push(d[j]);if(a.config.cleanModuleNamespace)f.info.hasCleanNamespace||
a.console.warn("Warning: Module '"+b+"' may have unclean namespace, but JOBAD.config.cleanModuleNamespace is true. ");else for(g in d=a.refs._.clone(f.namespace),d)!a.modules.cleanProperties.hasOwnProperty(g)&&d.hasOwnProperty(g)&&(this[g]=d[g]);for(g in a.modules.extensions)h=a.modules.extensions[g],j=f[g],"function"==typeof h.onLoad&&h.onLoad.call(this,j,f,this);for(j=0;j<a.modules.ifaces.length;j++)h=a.modules.ifaces[j],h[1].call(this,f);this.onActivate=f.activate;this.onDeactivate=f.deactivate;
this.activate=function(){return c.modules.activate(this.info().identifier)};this.deactivate=function(){return c.modules.deactivate(this.info().identifier)};f.init.apply(this,k)};a.ifaces.push(function(b){this.Event={};this.Setup=function(){return b.Setup.enable()};this.Setup.enable=function(){var c=b.element,d;for(d in b.Event)a.Events[d].Setup.enable.call(b,c);return!0};this.Setup.disable=function(){return!1};for(var d in a.Events)if(a.Events.hasOwnProperty(d)&&!a.isEventDisabled(d))if(b.Event[d]=
a.util.bindEverything(a.Events[d].namespace,b),"function"==typeof a.Events[d].Setup.init)a.Events[d].Setup.init.call(b,b);else if("object"==typeof a.Events[d].Setup.init)for(var c in a.Events[d].Setup.init)a.Events[d].Setup.init.hasOwnProperty(c)&&(b.hasOwnProperty(c)?a.console.warn("Setup: Event '"+d+"' tried to override '"+c+"'"):b[c]=a.util.bindEverything(a.Events[d].Setup.init[c],b))});a.modules.ifaces.push([function(b,d){for(var c in a.Events)d.hasOwnProperty(c)&&(b[c]=d[c]);return b},function(b){for(var d in a.Events)this[d]=
b.hasOwnProperty(d)?b[d]:a.Events[d]["default"]}]);a.isEventDisabled=function(b){return-1!=a.config.disabledEvents.indexOf(b)};a.Events={};a.config.disabledEvents=[];a.config.cleanModuleNamespace=!1;var q=[0,0];a.refs.$(document).on("mousemove.JOBADListener",function(b){q=[b.pageX-a.refs.$(window).scrollLeft(),b.pageY-a.refs.$(window).scrollTop()]});a.UI={};a.UI.hover={};a.UI.hover.config={offsetX:10,offsetY:10,hoverDelay:1E3};var r=!1,n=void 0;a.UI.hover.enable=function(b,d){r=!0;n=a.refs.$("<div class='JOBAD'>").addClass(d).html(b);
n.appendTo(a.refs.$("body"));a.refs.$(document).on("mousemove.JOBAD.UI.hover",function(){a.UI.hover.refresh()});a.UI.hover.refresh();return!0};a.UI.hover.disable=function(){if(!r)return!1;r=!1;a.refs.$(document).off("mousemove.JOBAD.UI.hover");n.remove()};a.UI.hover.refresh=function(){r&&n.css("top",Math.min(q[1]+a.UI.hover.config.offsetY,window.innerHeight-n.outerHeight(!0))).css("left",Math.min(q[0]+a.UI.hover.config.offsetX,window.innerWidth-n.outerWidth(!0)))};a.UI.ContextMenu={};a.UI.ContextMenu.config=
{margin:20,width:250};a.UI.ContextMenu.enable=function(b,d,c,e){if("function"!=typeof d)return a.error("JOBAD.UI.ContextMenu.enable: demandFunction is not a function"),b;"function"!=typeof c&&(c=function(){});"function"!=typeof e&&(e=function(){});b.on("contextmenu.JOBAD.UI.ContextMenu",function(f){if(f.ctrlKey)return!0;var g=a.refs.$(f.target);f=a.refs.$(f.target);for(var h=!1;!(h=d(g,f))&&!b.is(this);)g=g.parent();if(!h)return!0;a.refs.$(document).trigger("JOBADContextMenuUnbind");c(b);var j=a.UI.ContextMenu.buildMenuList(h,
g,f).menu().css({width:a.UI.ContextMenu.config.width,position:"fixed"}).on("contextmenu",function(){return!1}).on("mousedown",function(a){a.stopPropagation()}).appendTo(a.refs.$("body"));j.css("top",Math.min(q[1],window.innerHeight-j.outerHeight(!0)-a.UI.ContextMenu.config.margin)).css("left",Math.min(q[0],window.innerWidth-j.outerWidth(!0)-a.UI.ContextMenu.config.margin));a.refs.$(document).on("JOBADContextMenuUnbind",function(){j.remove();e(b);a.refs.$(document).unbind("mousedown.UI.ContextMenu.Unbind JOBADContextMenuUnbind")});
a.refs.$(document).on("mousedown.UI.ContextMenu.Unbind",function(){a.refs.$(document).trigger("JOBADContextMenuUnbind")});return!1});return b};a.UI.ContextMenu.disable=function(a){a.off("contextmenu.JOBAD.UI.ContextMenu");return a};a.UI.ContextMenu.buildMenuList=function(b,d,c){for(var e=a.refs.$("<ul class='JOBAD JOBAD_Contextmenu'>"),f=0;f<b.length;f++){var g=b[f],h=a.refs.$("<a href='#'>");$li=a.refs.$("<li>").appendTo(e).append(h);h.text(g[0]).on("click",function(){return!1});(function(){if("function"==
typeof g[1]){var b=g[1];h.on("click",function(){a.refs.$(document).trigger("JOBADContextMenuUnbind");b(d,c)})}else $li.append(a.UI.ContextMenu.buildMenuList(g[1],d,c))})()}return e};a.UI.Sidebar={};a.UI.Sidebar.config={width:100,iconDistance:15,icons:{warning:"data:image/png;base64,",
...
a.UI.Sidebar.wrap=function(b){b=$(b);var d=a.refs.$("<div>").css({overflow:"hidden"}),c=a.refs.$("<div class='JOBAD JOBAD_Sidebar JOBAD_Sidebar_Container'>").css({width:a.UI.Sidebar.config.width}),e=a.refs.$("<div class='JOBAD JOBAD_Sidebar JOBAD_Sidebar_Wrapper'>");b.wrap(d);d=b.parent();d.wrap(e);e=d.parent();e.prepend(c);a.refs.$(window).on("resize.JOBAD.UI.Sidebar",function(){var b=c.find("*").filter(function(){return!0===a.refs.$(this).data("JOBAD.UI.Sidebar.isElement")});b.each(function(b,d){d=
a.refs.$(d).detach().appendTo(c).addClass("JOBAD_Sidebar_Single");var e=d.data("JOBAD.UI.Sidebar.orgElement").offset().top-c.offset().top;d.css({top:e,right:0})});for(var b=a.refs.$(b.sort(function(b,c){b=a.refs.$(b);c=a.refs.$(c);return parseInt(b.css("top"))<parseInt(c.css("top"))?-1:parseInt(b.css("top"))>parseInt(c.css("top"))?1:0})),d=b.eq(0),e=b.eq(1),j=[[d]],k=1;k<b.length;k++){var l=parseInt(d.css("top"));parseInt(e.css("top"))-(l+d.height())<a.UI.Sidebar.config.iconDistance?j[j.length-1].push(e):
(j.push([e]),d=e);e=b.eq(k+1)}a.refs.$(b).detach();c.find("*").remove();for(k=0;k<j.length;k++)1<j[k].length?function(){var b=a.refs.$(j[k]),d=parseInt(a.refs.$(b[0]).css("top")),d=a.refs.$("<div class='JOBAD JOBAD_Sidebar JOBAD_Sidebar_group'><img src='"+a.UI.Sidebar.config.icons.multiple_open+"' width='16' height='16'></div>").css("top",d).appendTo(c),e=d.find("img"),f=!1;d.click(function(){if(f){for(var c=0;c<b.length;c++)b[c].hide();e.attr("src",a.UI.Sidebar.config.icons.multiple_open)}else{for(c=
0;c<b.length;c++)b[c].show();e.attr("src",a.UI.Sidebar.config.icons.multiple_close)}f=!f});for(var g=0;g<b.length;g++)a.refs.$(b[g]).appendTo(d).hide().removeClass("JOBAD_Sidebar_Single").addClass("JOBAD_Sidebar_group_element").css({right:20,top:-16})}():c.append(a.refs.$(j[k][0]).removeClass("JOBAD_Sidebar_group_element").show())});$(window).on("resize",function(){a.UI.Sidebar.forceNotificationUpdate()});b.data("JOBAD.UI.Sidebar.active",!0);return b};a.UI.Sidebar.unwrap=function(b){b=a.refs.$(b);
b.unwrap().parent().find("div").first().remove();b.removeData("JOBAD.UI.Sidebar.active");return b.unwrap()};a.UI.Sidebar.addNotification=function(b,d,c){c="undefined"==typeof c?{}:c;b=a.refs.$(b);var e=a.refs.$(d).offset().top-b.offset().top;b=b.parent().parent().find("div").first();var f=a.refs.$("<div class='JOBAD JOBAD_Sidebar JOBAD_Sidebar_Notification'>").css({top:e}).appendTo(b);f.data("JOBAD.UI.Sidebar.orgElement",d);f.data("JOBAD.UI.Sidebar.isElement",!0);if("undefined"!=typeof c.menu){var g=
a.util.fullWrap(c.menu,function(a){return a.apply(f,[d,c.menuThis])});a.UI.ContextMenu.enable(f,function(){return g})}c.hasOwnProperty("text")&&f.text(c.text);c.trace&&f.hover(function(){a.UI.highlight(d)},function(){a.UI.unhighlight(d)});"function"==typeof c.click&&f.click(c.click);b=!1;if("string"==typeof c["class"]){var h=c["class"];a.UI.Sidebar.config.icons.hasOwnProperty(h)&&(b=a.UI.Sidebar.config.icons[h])}"string"==typeof c.icon&&(b=c.icon);"string"==typeof b?f.html("<img src='"+b+"' width='16px' height='16px'>").hover(function(){a.UI.hover.enable(a.refs.$("<div>").text(c.text).html(),
"JOBAD_Sidebar_Hover JOBAD_Sidebar "+("string"==typeof c["class"]?" JOBAD_Notification_"+c["class"]:""))},function(){a.UI.hover.disable()}):f.addClass("JOBAD_Notification_"+h);return f};a.UI.Sidebar.forceNotificationUpdate=function(){a.refs.$(window).trigger("resize.JOBAD.UI.Sidebar")};a.UI.Sidebar.removeNotification=function(a){a.remove()};a.UI.highlight=function(b){b=a.refs.$(b);var d;d="string"==typeof b.data("JOBAD.UI.highlight.orgColor")?b.data("JOBAD.UI.highlight.orgColor"):b.css("backgroundColor");
b.stop().data("JOBAD.UI.highlight.orgColor",d).animate({backgroundColor:"#FFFF9C"},1E3)};a.UI.unhighlight=function(b){b=a.refs.$(b);b.stop().animate({backgroundColor:b.data("JOBAD.UI.highlight.orgColor"),finish:function(){b.removeData("JOBAD.UI.highlight.orgColor")}},1E3)};a.Events.leftClick={"default":function(){return!1},Setup:{enable:function(b){var d=this;b.delegate("*","click.JOBAD.leftClick",function(c){var e=a.refs.$(c.target);switch(c.which){case 1:d.Event.leftClick.trigger(e),c.stopPropagation()}b.trigger("JOBAD.Event",
["leftClick",e])})},disable:function(a){a.undelegate("*","click.JOBAD.leftClick")}},namespace:{getResult:function(a){return this.modules.iterateAnd(function(d){d.leftClick.call(d,a,d.getJOBAD());return!0})},trigger:function(a){return this.Event.leftClick.getResult(a)}}};a.Events.onEvent={"default":function(){},Setup:{enable:function(a){var d=this;a.on("JOBAD.Event",function(a,b,f){d.Event.onEvent.trigger(b,f)})},disable:function(a){a.off("JOBAD.Event")}},namespace:{getResult:function(a,d){return this.modules.iterateAnd(function(c){c.onEvent.call(c,
a,d,c.getJOBAD());return!0})},trigger:function(a,d){return this.Event.onEvent.getResult(a,d)}}};a.Events.contextMenuEntries={"default":function(){return[]},Setup:{enable:function(b){var d=this;a.UI.ContextMenu.enable(b,function(a){var e=d.Event.contextMenuEntries.getResult(a);b.trigger("JOBAD.Event",["contextMenuEntries",a]);return e})},disable:function(b){a.UI.ContextMenu.disable(b)}},namespace:{getResult:function(b){for(var d=[],c=this.modules.iterate(function(c){c=c.contextMenuEntries.call(c,b,
c.getJOBAD());return a.refs._.isArray(c)?c:a.util.generateMenuList(c)}),e=0;e<c.length;e++)for(var f=c[e],g=0;g<f.length;g++)d.push(f[g]);return 0==d.length?!1:d}}};a.util.generateMenuList=function(b){if("undefined"==typeof b)return[];var d=[],c;for(c in b)if(b.hasOwnProperty(c)){var e=b[c];"function"==typeof e?d.push([c,e]):d.push([c,a.util.generateMenuList(e)])}return d};a.util.fullWrap=function(b,d){b=a.refs._.isArray(b)?b:a.util.generateMenuList(b);for(var c=[],e=0;e<b.length;e++)"function"==
typeof b[e][1]?function(){var a=b[e][1];c.push([b[e][0],function(){return d(a,arguments)}])}():c.push([b[e][0],a.util.fullWrap(b[e][1])]);return c};a.Events.hoverText={"default":function(){return!1},Setup:{init:function(){this.Event.hoverText.activeHoverElement=void 0},enable:function(b){var d=this;b.delegate("*","mouseenter.JOBAD.hoverText",function(c){var e=a.refs.$(this);d.Event.hoverText.trigger(e)?c.stopPropagation():e.is(b)||a.refs.$(this).parent().trigger("mouseenter.JOBAD.hoverText",c);b.trigger("JOBAD.Event",
["hoverText",e]);return!1}).delegate("*","mouseleave.JOBAD.hoverText",function(){return d.Event.hoverText.untrigger(a.refs.$(this))})},disable:function(a){"undefined"!=typeof this.Event.hoverText.activeHoverElement&&me.Event.hoverText.untrigger();a.undelegate("*","mouseenter.JOBAD.hoverText").undelegate("*","mouseleave.JOBAD.hoverText")}},namespace:{getResult:function(b){var d=!1;this.modules.iterate(function(c){var e=c.hoverText.call(c,b,c.getJOBAD());if("undefined"!=typeof e&&"boolean"==typeof d)if("string"==
typeof e)d=a.refs.$("<p>").text(e);else if("boolean"!=typeof e)try{d=a.refs.$(e)}catch(f){a.error("Module '"+c.info().identifier+"' returned invalid HOVER result. ")}else!0===e&&(d=!0);return!0});return d},trigger:function(b){if(b.data("JOBAD.hover.Active"))return!1;var d=this.Event.hoverText.getResult(b);if("boolean"==typeof d)return d;if(this.Event.hoverText.activeHoverElement instanceof a.refs.$){if(this.Event.hoverText.activeHoverElement.is(b))return!0;this.Event.hoverText.untrigger(this.Event.hoverText.activeHoverElement)}this.Event.hoverText.activeHoverElement=
b;b.data("JOBAD.hover.Active",!0);var c=window.setTimeout(function(){b.removeData("JOBAD.hover.timerId");a.UI.hover.enable(d.html(),"JOBAD_Hover")},a.UI.hover.config.hoverDelay);b.data("JOBAD.hover.timerId",c);return!0},untrigger:function(b){if("undefined"==typeof b)if(this.Event.hoverText.activeHoverElement instanceof a.refs.$)b=this.Event.hoverText.activeHoverElement;else return!1;if(!b.data("JOBAD.hover.Active"))return!1;"number"==typeof b.data("JOBAD.hover.timerId")&&(window.clearTimeout(b.data("JOBAD.hover.timerId")),
...
else{this.element.data("JOBAD.UI.Sidebar.active")||a.UI.Sidebar.wrap(this.element);for(var b in this.Sidebar.Elements){var d=this.Sidebar.Elements[b];d.data("JOBAD.Events.Sidebar.id")||(this.Sidebar.Elements[b]=a.UI.Sidebar.addNotification(this.element,this.Sidebar.Elements[b],d.data("JOBAD.Events.Sidebar.config")))}}a.UI.Sidebar.forceNotificationUpdate();this.Event.onSideBarUpdate.trigger()},registerNotification:function(b,d){"undefined"==typeof this.Sidebar.Elements&&(this.Sidebar.Elements={});
b=a.refs.$(b);var c=(new Date).getTime().toString();d="undefined"==typeof d?{}:d;d.menuThis=this;this.Sidebar.Elements[c]=b.data("JOBAD.Events.Sidebar.config",d);this.Sidebar.redraw();c=this.Sidebar.Elements[c].data("JOBAD.Events.Sidebar.id",c);c.data("JOBAD.Events.Sidebar.element",b);return c},removeNotification:function(b){if(b instanceof a.refs.$){var d=b.data("JOBAD.Events.Sidebar.id");a.UI.Sidebar.removeNotification(b);delete this.Sidebar.Elements[d];this.Sidebar.redraw()}else a.error("JOBAD Sidebar Error: Tried to remove invalid Element. ")}}},
enable:function(){this.Event.onSideBarUpdate.enabled=!0},disable:function(){this.Event.onSideBarUpdate.enabled=void 0}},namespace:{getResult:function(){this.Event.onSideBarUpdate.enabled&&this.modules.iterateAnd(function(a){a.onSideBarUpdate.call(a,a.getJOBAD());return!0})},trigger:function(){this.Event.onSideBarUpdate.getResult()}}};for(var s in a.Events)a.modules.cleanProperties.push(s);a.storageBackend={getKey:function(b,d){var c=a.storageBackend.engines[a.config.storageBackend][0](b);return"string"==
typeof c?JSON.parse(c):d},setKey:function(b,d){return a.storageBackend.engines[a.config.storageBackend][1](b,JSON.stringify(d))}};a.storageBackend.engines={none:[function(){},function(){}]};a.config.storageBackend="none";a.util.validateConfigSetting=function(b,d,c){if(!b.hasOwnProperty(d))return a.console.warn("Undefined user setting: "+d),!1;var e=b[d][0];b=b[d][1];switch(e){case "string":return"string"!=typeof c?!1:a.refs._.isRegExp(b)?b.test(c):"function"==typeof b?b(c):!0;case "bool":return"boolean"==
typeof c;case "integer":return"number"!=typeof c||0!=c%1?!1:"function"==typeof b?b(c):a.refs._.isArray(b)?c>=b[0]&&c<=b[1]:!0;case "number":return"number"!=typeof c?!1:"function"==typeof b?b(c):a.refs._.isArray(b)?c>=b[0]&&c<=b[1]:!0;case "list":return-1!=b.indexOf(c);default:a.console.warn("Unknown configuration type '"+e+"' for user setting '"+d+"'")}};a.util.getDefaultConfigSetting=function(b,d){if(b.hasOwnProperty(d)){var c=b[d][2];if(a.util.validateConfigSetting(b,d,c))return c;a.console.warn("Undefined user setting: "+
b)}else a.console.warn("Undefined user setting: "+d)};var m={};a.modules.extensions.config={required:!1,validate:function(){return!0},init:function(a,d){return a?d:{}},onLoad:function(b,d){var c=d.info.identifier;this.UserConfig={};this.UserConfig.set=function(b,d){this.UserConfig.canSet(b,d)?m[c][b]=d:a.console.warn("Can not set user config '"+b+"': Validation failure. ");a.storageBackend.setKey(c,m[c])};this.UserConfig.canSet=function(c,d){return a.util.validateConfigSetting(b,c,d)};this.UserConfig.get=
function(d){var f=m[c][d];if(a.util.validateConfigSetting(b,d,f))return f;a.console.log("Failed to access user setting '"+d+"'")};this.UserConfig.getTypes=function(){return a.refs._.clone(b)};this.UserConfig.reset=function(){m[c]=a.storageBackend.getKey(c);if("undefined"==typeof m[c]){m[c]={};for(var d in b)m[c][d]=a.util.getDefaultConfigSetting(b,d)}};m.hasOwnProperty(c)||this.UserConfig.reset()}};a.ifaces.push(function(){this.showConfigUI=function(){var b=a.refs.$("<div>");b.attr("title","JOBAD Configuration Utility");
var d=this.modules.getIdentifiers(),c=a.refs.$("<table>").addClass("JOBAD JOBAD_ConfigUI JOBAD_ConfigUI_tablemain").append(a.refs.$("<colgroup>").append(a.refs.$("<col>").css("width","10%"),a.refs.$("<col>").css("width","90%"))),e=d.length,f=a.refs.$("<td>").addClass("JOBAD JOBAD_ConfigUI JOBAD_ConfigUI_infobox").attr("rowspan",e+1),g=function(){f.trigger("JOBAD.modInfoClose").html("").text("JOBAD Core Info will go here").one("JOBAD.modInfoClose",function(){a.console.log("ModCloseSafe: <main>")})};
$("<tr>").append($("<td>").text("JOBAD Core").click(g),f).appendTo(c);for(var h=0;h<e;h++){var j=this.modules.getLoadedModule(d[h]);a.refs.$("<tr>").append($("<td>").text(j.info().identifier).data("JOBAD.module",j).click(function(){var b=a.refs.$(this).data("JOBAD.module");f.trigger("JOBAD.modInfoClose").html("").text(b.info().description).one("JOBAD.modInfoClose",function(){a.console.log("ModCloseSafe: "+b.info().identifier)})})).appendTo(c)}b.append(c);b.dialog({modal:!0,width:600,height:450,open:g,
close:function(){f.trigger("JOBAD.modInfoClose")}})}});for(s in a.modules.extensions)a.modules.cleanProperties.push(s);return a}();
